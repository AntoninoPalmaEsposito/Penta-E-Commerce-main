...
<!- Nav sx -->
    ...
    <header>
        ...
        <nav class="flex items-center w-[100vw] h-[100px] px-[20px] md:px-[40px] justify-between ">
            <div class="flex items-center w-full justify-between">
                ...
                <div class="w-[80%] flex items-center">
                    ...
                    <ul class="text-[20px] max-[1240px]:hidden flex gap-3 xl:gap-5  ml-[80px] ">
                        <RouterLink to="/shop" class=" hover:underline">Shop </RouterLink>
                        <RouterLink to="/gaming" class=" font-medium hover:underline">Gaming</RouterLink>
                        <RouterLink to="/fotografia" class=" hover:underline">Fotografia</RouterLink>
                        <RouterLink to="/elettronica" class=" hover:underline">Elettronica</RouterLink>
                        <RouterLink to="/elettrodomestici" class=" hover:underline">Elettrodomestici</RouterLink>
                        <RouterLink to="/casa" class=" hover:underline">Casa</RouterLink>
